...

                {
                    file ?
                        ...
                        <div className='relative flex flex-col items-center justify-center rounded-lg p-2'>
                            ...
                            <Image src={URL.createObjectURL(file)} width={150} height={80} alt='' />
                            ...
                            <div className='flex flex-col items-center justify-center mt-2'>
                                ...
                                <button onClick={handleUpload} className="px-4 py-2 mt-4 text-sm font-semibold text-white bg-blue-400 rounded-md hover:bg-blue-500 focus:outline-none focus:ring">Uploader</button>
                            </div>
                        </div>
                        :
